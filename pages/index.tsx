      ...
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          <div className={styles['main-div']}>
            ...
            <p>See excerpted speeches below, as well as in <a href={"https://www.youtube.com/playlist?list=PLRsgii8jpqjbDMkggY2Xtqox5fGk-Bl11"}>this YouTube Playlist</a> and <a href={"https://www.youtube.com/watch?v=dsLHqLm5C3w"}>this combined video</a>:</p>
